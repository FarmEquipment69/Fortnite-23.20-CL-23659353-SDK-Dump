// WidgetBlueprintGeneratedClass /Game/UI/SocialPanel/ListEntries/UserListEntry_XS.UserListEntry_XS_C
// Size: 0x1548
class UUserListEntry_XS_C : public UFortSocialUserListEntry
{
	...
	// Function /Game/UI/SocialPanel/ListEntries/UserListEntry_XS.UserListEntry_XS_C.BP_OnUnhovered (Has no native function)
	void BPOnUnhovered(); // (Event | Protected | BlueprintEvent)

	// Function /Game/UI/SocialPanel/ListEntries/UserListEntry_XS.UserListEntry_XS_C.BndEvt__MenuAnchor_Actions_K2Node_ComponentBoundEvent_0_OnMenuOpenChangedEvent__DelegateSignature (Has no native function)
	...
	// Function /Game/UI/SocialPanel/ListEntries/UserListEntry_XS.UserListEntry_XS_C.BP_OnHovered (Has no native function)
	void BPOnHovered(); // (Event | Protected | BlueprintEvent)

	// Function /Game/UI/SocialPanel/ListEntries/UserListEntry_XS.UserListEntry_XS_C.OnFocusLost (Has no native function)
	void OnFocusLost(struct FFocusEvent*& InFocusEvent); // (BlueprintCosmetic | Event | Public | BlueprintEvent)

	// Function /Game/UI/SocialPanel/ListEntries/UserListEntry_XS.UserListEntry_XS_C.ExecuteUbergraph_UserListEntry_XS (Has no native function)
	void ExecuteUbergraphUserListEntryXS(int& EntryPoint, struct FFocusEvent*& K2NodeEventInFocusEvent, bool& K2NodeComponentBoundEventbIsOpen, class UUMGSequencePlayer*& CallFuncPlayAnimationReturnValue, class UUMGSequencePlayer*& CallFuncPlayAnimationReturnValue1, class UUMGSequencePlayer*& CallFuncPlayAnimationReturnValue2, bool& CallFuncIsAnimationPlayingReturnValue, class UUMGSequencePlayer*& CallFuncPlayAnimationReturnValue3); // (Final | 0x00008000 | HasDefaults)
};
