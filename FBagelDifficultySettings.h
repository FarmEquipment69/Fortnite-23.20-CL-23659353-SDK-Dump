// ScriptStruct /Script/FortniteGame.BagelDifficultySettings
// Size: 0xa8
struct FBagelDifficultySettings
{
	struct FScalableFloat SpawnCountPlayerCountMultiplier; // 0x0 (0x28)
	...
	float SpawnCountMultiplier; // 0xa0 (0x4)
	float AIEffectMultiplier; // 0xa4 (0x4)
};
