// WidgetBlueprintGeneratedClass /Game/UI/Foundation/Stats/PowerRatingWidget.PowerRatingWidget_C
// Size: 0x344
class UPowerRatingWidget_C : public UFortPlayerPowerRating
{
	...
	class UVerticalBox* OversizedMode; // 0x2f0 (0x8)
	class UImage* PowerIconGlow; // 0x2f8 (0x8)
	class UImage* RatingGlowLarge; // 0x300 (0x8)
	class USizeBox* RatingBar; // 0x308 (0x8)
	class UHorizontalBox* RegularMode; // 0x310 (0x8)
	class UCommonNumericTextBlock* TeamRatingValue; // 0x318 (0x8)
	class UCommonNumericTextBlock* TeamRatingValueLarge; // 0x320 (0x8)
	bool ShowDualPower; // 0x328 (0x1)
	bool ShowProgress; // 0x329 (0x1)
	bool ShowGlow; // 0x32a (0x1)
	bool UseLargeStyle; // 0x32b (0x1)
	bool UseOversizedMode; // 0x32c (0x1)
	unsigned char unreflected_32d[0x3]; // 0x32d (0x3) 
	double InterpDuration; // 0x330 (0x8)
	class USoundBase* PowerIncreasedSound; // 0x338 (0x8)
	int PowerRatingNum; // 0x340 (0x4)

	/* Functions */

	// Function /Game/UI/Foundation/Stats/PowerRatingWidget.PowerRatingWidget_C.UpdateWidgetState (Has no native function)
