// ScriptStruct /Script/FortniteGame.FortAnimNode_SpeedWarping
// Size: 0x200
struct FFortAnimNode_SpeedWarping : FAnimNode_SkeletalControlBase
{
	...
	enum ESpeedWarpingAxisMode SpeedWarpingAxisMode; // 0x10c (0x1)
	enum ESpeedWarpingAxisMode FloorNormalAxisMode; // 0x10d (0x1)
	enum ESpeedWarpingAxisMode GravityDirAxisMode; // 0x10e (0x1)
	...
	struct FVector ManualSpeedWarpingDir; // 0x148 (0x18)
	...
	unsigned char bOrientSpeedWarpingAxisBasedOnFloorNormal; // 0x1f8 (0x1)
