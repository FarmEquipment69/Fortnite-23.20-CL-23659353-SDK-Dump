...
class UFortVoiceChatStatusIcon : public UWidget
{
	...
	class UMaterialInterface* VoiceChatStatusMaterial; // 0x1a0 (0x8)
	...
	// Function /Script/FortniteUI.FortVoiceChatStatusIcon.SetImageColorAndOpacity (Underlying native function: SetImageColorAndOpacity 0xa93a3c8)
