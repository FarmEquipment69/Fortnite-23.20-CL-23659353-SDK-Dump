...
class UFortItemManagementMulchDetailsPanel_STW : public UCommonUserWidget
{
	...
	// Function /Script/SaveTheWorldUI.FortItemManagementMulchDetailsPanel_STW.IsSpaceAvailableForMulch (Underlying native function: IsSpaceAvailableForMulch 0x7599250)
	...
	// Function /Script/SaveTheWorldUI.FortItemManagementMulchDetailsPanel_STW.GetItemsToMulch (Underlying native function: GetItemsToMulch 0x7596fe8)
	struct TArray<class UFortItem*> GetItemsToMulch(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortItemManagementMulchDetailsPanel_STW.GetItemCountsToMulch (Underlying native function: GetItemCountsToMulch 0x7596cd8)
	struct TArray<int> GetItemCountsToMulch(); // (Final | Native | Protected | BlueprintCallable | BlueprintPure | Const)

	// Function /Script/SaveTheWorldUI.FortItemManagementMulchDetailsPanel_STW.CommitMulch (Underlying native function: CommitMulch 0x759576c)
