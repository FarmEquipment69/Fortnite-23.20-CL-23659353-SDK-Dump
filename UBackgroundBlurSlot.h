...
class UBackgroundBlurSlot : public UPanelSlot
{
	...
	// Function /Script/UMG.BackgroundBlurSlot.SetVerticalAlignment (Underlying native function: SetVerticalAlignment 0x9aefc20)
	...
	// Function /Script/UMG.BackgroundBlurSlot.SetPadding (Underlying native function: SetPadding 0x9aeef54)
	void SetPadding(struct FMargin& InPadding); // (Final | Native | Public | BlueprintCallable)

	// Function /Script/UMG.BackgroundBlurSlot.SetHorizontalAlignment (Underlying native function: SetHorizontalAlignment 0x9aee65c)
